...
This report validates proposal-declared and standalone tmp work-order zip structure and entry-name leak policy only.
...
| --- | --- | --- | --- | --- | ---: | --- | --- |
| `proposal` | `fda_warning_letter_response_assessment_item_v1` | `source_only_candidate_oracle_review` | `tmp/fda_response_assessment_item_blind_review_work_order_20260604.zip` | `fda_warning_letter_domain_transfer_001, fda_warning_letter_domain_transfer_002, fda_warning_letter_domain_transfer_003` | 17 | `[]` | `[]` |
...
| `tmp_zip` | `fda_t002_unexpected_blind_review_work_order_20260604` | `standalone_external_work_order` | `tmp/fda_t002_unexpected_blind_review_work_order_20260604.zip` | `.` | 5 | `[]` | `[]` |
