...
| Glass Tide Charter | cold profile bootstrap initially failed JSON; assisted starter first-20 was `7 exact / 2 partial / 11 miss` | cold compact bootstrap first-20 `13 exact / 3 partial / 4 miss`; GLT-023 has a probe-gated role-joined repair rule with `1/1` positive and `1/1` negative probes; GLT-027 deterministically unions separate threshold and exception lenses into `3` promotion-ready tax rules with `3/3` positive and `1/1` negative probes | Rule ingestion needs planned semantic lenses, active predicate palettes, helper substrates, body-goal support checks, positive/negative probes, and runtime verifier diagnostics, not more rule prose inside the default compile. |
