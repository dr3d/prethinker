...
| `fda_response_assessment_item_oracle_review_20260604_fda_warning_letter_domain_transfer_002` | `fda_warning_letter_domain_transfer_002` | `fda_response_assessment_item/6` | 3 | 8 | `True` | `False` | `[]` | `['candidate_forbidden_facts.pl:line_8:forbidden_value_domain:cgmps_citation:value_not_allowed:cfr_21_211_58', 'candidate_forbidden_facts.pl:line_20:forbidden_atom_shape:quoted_atom_contains_whitespace:arg6']` |
| `fda_response_assessment_item_oracle_review_20260604_fda_warning_letter_domain_transfer_003` | `fda_warning_letter_domain_transfer_003` | `fda_response_assessment_item/6` | 1 | 8 | `True` | `False` | `[]` | `['candidate_forbidden_facts.pl:line_12:forbidden_value_domain:cgmps_citation:value_not_allowed:cfr_21_211_63', 'candidate_forbidden_facts.pl:line_16:forbidden_value_domain:cgmps_citation:value_not_allowed:cfr_21_211_34', 'candidate_forbidden_facts.pl:line_22:forbidden_atom_shape:quoted_atom_contains_whitespace:arg6']` |
...
| `sec_t001_source_review_20260605_sec_exhibit_5` | `sec_form_8k_skeleton_transfer_001` | `sec_exhibit/5` | 0 | 6 | `True` | `False` | `[]` | `[]` |
| `sec_t001_source_review_20260605_sec_registrant_4` | `sec_form_8k_skeleton_transfer_001` | `sec_registrant/4` | 0 | 2 | `True` | `False` | `[]` | `[]` |
| `sec_t001_source_review_20260605_sec_registrant_identifier_5` | `sec_form_8k_skeleton_transfer_001` | `sec_registrant_identifier/5` | 0 | 2 | `True` | `False` | `[]` | `[]` |
