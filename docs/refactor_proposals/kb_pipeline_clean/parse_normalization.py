...
NORMALIZER_PIPELINE: tuple[NormalizerSpec, ...] = (
    ...
    NormalizerSpec(
        phase="story_world",
        new_name="story_world_observation_normalizer",
        legacy_symbols=(
        ...
        trace_event="story_world_observation_normalized",
    ),
    NormalizerSpec(
        phase="group_event",
        new_name="group_event_normalizer",
        legacy_symbols=("_apply_group_returned_home_guard",),
        operates_on=("event clauses", "entity groups"),
        trace_event="group_event_normalized",
    ),
    NormalizerSpec(
        phase="possessive_object",
        new_name="possessive_object_normalizer",
        legacy_symbols=("_apply_possessive_break_guard", "_apply_possessive_bed_target_guard"),
        operates_on=("possessive object terms", "facts"),
        trace_event="possessive_object_normalized",
    ),
    NormalizerSpec(
        phase="rule_query",
    ...
    NormalizerSpec(
        phase="narrative",
        new_name="narrative_fact_and_rule_normalizer",
        legacy_symbols=(
        ...
        trace_event="narrative_shape_normalized",
    ),
)
