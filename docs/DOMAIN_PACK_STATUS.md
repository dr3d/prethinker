...
- Domains: `8`
- Predicates: `75` (`69` domain-specific plus shared carriers)
- Lenses: `34`
- Associated fixtures: `43`
- Unassigned fixtures: `4`
- Unassigned fixtures accounted for: `4 / 4`
- Expected facts in associated fixtures: `787`
- Forbidden facts in associated fixtures: `310`
...
| `legal_authority_verification_v1` | 13 | 12 | 3 | 13 | 214 | 60 |
...
| Lens | Allowed signatures |
| --- | --- |
| `citation_resolution` | `legal_citation_mention/5`, `legal_authority_resolution/5`, `legal_authority_metadata_check/5`, `legal_authority_text_source/5`, `legal_verification_abstention/4`, `domain_omission/5` |
| `quote_pin_check` | `legal_quote_claim/5`, `legal_authority_text_source/5`, `legal_quote_span_match/5`, `legal_pin_cite_check/5`, `legal_verification_abstention/4`, `domain_omission/5` |
| `proposition_boundary` | `legal_proposition_claim/5`, `legal_proposition_source_span/5`, `legal_support_assessment/5`, `legal_proposition_support_boundary/5`, `legal_verification_abstention/4`, `domain_omission/5` |
...
| `legal_authority_verification_micro_v10` | `fixture_id_prefix` | 22 | 5 | `legal_authority_metadata_check/5`:10, `legal_authority_resolution/5`:3, `legal_authority_text_source/5`:2, `legal_citation_mention/5`:3, `legal_quote_claim/5`:1, `legal_quote_span_match/5`:1, `legal_verification_abstention/4`:2 |
| `legal_authority_verification_micro_v11` | `fixture_id_prefix` | 13 | 4 | `legal_authority_metadata_check/5`:5, `legal_authority_resolution/5`:1, `legal_authority_text_source/5`:1, `legal_citation_mention/5`:1, `legal_proposition_claim/5`:1, `legal_proposition_source_span/5`:1, `legal_proposition_support_boundary/5`:1, `legal_support_assessment/5`:1, `legal_verification_abstention/4`:1 |
| `legal_authority_verification_micro_v12` | `fixture_id_prefix` | 9 | 2 | `legal_authority_metadata_check/5`:6, `legal_authority_resolution/5`:1, `legal_authority_text_source/5`:1, `legal_citation_mention/5`:1 |
| `legal_authority_verification_micro_v13` | `fixture_id_prefix` | 9 | 6 | `legal_authority_resolution/5`:3, `legal_citation_mention/5`:3, `legal_verification_abstention/4`:3 |
...
| `legal_authority_verification_micro_v7` | `fixture_id_prefix` | 1 | 2 | `legal_verification_abstention/4`:1 |
| `legal_authority_verification_micro_v8` | `fixture_id_prefix` | 1 | 2 | `legal_verification_abstention/4`:1 |
| `legal_authority_verification_micro_v9` | `fixture_id_prefix` | 12 | 4 | `legal_authority_metadata_check/5`:5, `legal_authority_resolution/5`:1, `legal_authority_text_source/5`:1, `legal_citation_mention/5`:1, `legal_pin_cite_check/5`:1, `legal_quote_claim/5`:1, `legal_quote_span_match/5`:1, `legal_verification_abstention/4`:1 |
