...
| `clinic_recall_support` | 1 | yes | split, audit ongoing | transfer: 17 clean / 9 candidate | Device/serial field rows plus generic manufacturer-liaison and verification-procedure atoms are clean; named-clinic, cabinet/seal/key, authority, and remaining procedure/clinic recognizers remain candidate. | Rewrite candidate recognizers over generic source-record fields/labels or quarantine them. |
