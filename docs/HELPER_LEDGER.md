...
student membership rows candidate. The next legitimate promotion path is a
third roster transfer fixture or a deterministic roster-table precompile ledger,
not relabeling the current parser output.
