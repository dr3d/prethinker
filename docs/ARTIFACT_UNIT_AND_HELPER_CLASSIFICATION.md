...
| clinic recall support | Split, audit ongoing | Device/serial rows plus generic manufacturer-liaison and verification-procedure atoms are labeled `clean-helper`; named-clinic, cabinet, seal, and authority recognizers remain `candidate-helper`. |
