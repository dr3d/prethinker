...
| industrial sensor support | Split, audit ongoing | Field-driven event/timestamp/count and computed-duration rows are labeled `clean-helper`; stated-duration and exact prose recognizers are labeled `candidate-helper`. |
