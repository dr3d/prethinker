...
- SEC shows that a small closed skeleton pack can transfer across three unlike
  ...
  11/13 breadth root. A later omission-accountability guard cleaned invalid
...
cell was moved to the fresh current-pack retest:
