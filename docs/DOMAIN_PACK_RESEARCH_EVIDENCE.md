...
clean atom/lens/value gates. The stability read remains an `11-13/13` band, not
a fixed single number. This is a boundary result, not a new inflated SEC claim.
