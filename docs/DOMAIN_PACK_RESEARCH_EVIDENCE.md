...
2026-06-05 refresh shows the favorable end of the same-condition spread, so the
stability read is now an `11-13/13` band, not a fixed single number. This is a
boundary result, not a new inflated SEC claim.
