...
manifest and current compile-fact QA status fail because SEC seed emits one
source-rejected forbidden fact at support=3 and FDA transfer_002 emits one
source-rejected forbidden fact at support=2. The packet-shape audit itself is
clean after returned packets were retained or archived: 0 standalone pending
work-order zips, 0 proposal-declared pending zips, 0 blocking errors, and 0
warnings. That audit now enforces an answer-leak
