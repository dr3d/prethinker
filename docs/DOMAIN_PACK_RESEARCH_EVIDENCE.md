...
- SEC shows that a small closed skeleton pack can transfer across three unlike
  ...
  Repaired breadth over seed/transfer_001/transfer_002 now lands at
  12/13, 11/13, and 11/12; transfer_003 exposes unstable item-treatment recall
  and ordinary MoE wrapper jitter. A later omission-accountability guard cleaned
  invalid omission rows without lifting support; a later 2026-06-05 refresh
...
```text
overall support>=2: 115/141
SEC seed/transfer support>=2: 13/13, 11/13, 11/12, 11/13
