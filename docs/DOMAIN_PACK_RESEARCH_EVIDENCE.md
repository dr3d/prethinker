...
| State-AG | `state_ag_settlement_aod_transfer_003` strict transfer-oracle probe | `C:\prethinker_tmp_archive\state_ag_transfer_oracle_probe_20260605\state-ag-aod-t003-transfer-r1-20260605` | First scored State-AG transfer oracle: 0/29 support>=2, 0/12 supported forbidden, 123 registered typed facts, atom/lens/value-domain gates clean. Near-miss audit: only 1/29 is source-coordinate-only; 24/29 have stable same-subject/same-predicate variants. This is a clean boundary result for strict atom/value reproducibility, not a transfer win |
