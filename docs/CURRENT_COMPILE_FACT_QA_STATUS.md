...
- Support>=2: `117 / 138` expected typed facts
- Per-run exact: `333 / 414` deterministic fact rows
- Unexpected same-signature facts support>=2: `6`
...
| `osha_incident` | 2 | 33 / 35 | 89 / 105 | 0 | 0 | 0 |
