...
| 5 | Fixture-bank predicate packs | Which retained official-document families can become closed, lens-scoped predicate packs without collecting new documents or grinding rows? | `docs/DOMAIN_PACK_STATUS.md`, `docs/DOMAIN_ACCOUNTABILITY_STATUS.md`, `docs/FIXTURE_BANK_PREDICATE_PACK_WORKSHEET.md`, domain registries |
