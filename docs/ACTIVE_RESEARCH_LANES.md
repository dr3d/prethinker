...
compatibility rows, runtime load errors, or write proposals. The same public
claim also includes a clean four-fixture real-world spotcheck (`160 / 0 / 0`,
`4 / 4` compile gates) and sealed unseen authored transfer at `152 / 1 / 6`
over `160` rows (`95.0%` exact).
...
- investigate query-surface gaps: `20 -> 29`;
- inspect regressed fixtures, especially `black_lantern_maze`,
