...
6. [Public Docs Guide](https://github.com/dr3d/prethinker/blob/main/docs/PUBLIC_DOCS_GUIDE.md) - the full reading map.
7. [Explainer](https://github.com/dr3d/prethinker/blob/main/docs/EXPLAINER.md) - the plain-language project story.
8. [Generalization Baseline Matrix](https://github.com/dr3d/prethinker/blob/main/docs/GENERALIZATION_BASELINE_MATRIX.md) - cold unseen fixture results for checking transfer.
9. [Current Utterance Pipeline](https://github.com/dr3d/prethinker/blob/main/docs/CURRENT_UTTERANCE_PIPELINE.md) - how a turn moves through router, context, Semantic IR, mapper, query, clarification, or mutation.

Then go deeper:

- [Semantic IR Mapper Spec](https://github.com/dr3d/prethinker/blob/main/docs/SEMANTIC_IR_MAPPER_SPEC.md) - what the deterministic admission layer accepts, skips, blocks, or projects.
- [Post-Ingestion QA Surfaces](https://github.com/dr3d/prethinker/blob/main/docs/POST_INGESTION_QA_SURFACES.md) - how compiled KBs are queried and scored after intake.
- [Query Surface Mode Comparison](https://github.com/dr3d/prethinker/blob/main/docs/QUERY_SURFACE_MODE_COMPARISON.md) - query-mode selector comparisons and row-level activation evidence.
...
- [Chaos Prover Pattern Notes](https://github.com/dr3d/prethinker/blob/main/docs/CHAOS_PROVER_PATTERN_NOTES.md) - external pattern notes for verifier/telemetry inspiration.
...
- [Query Surface Mode Comparison](https://github.com/dr3d/prethinker/blob/main/docs/QUERY_SURFACE_MODE_COMPARISON.md)
...
- [Console Trybook](https://github.com/dr3d/prethinker/blob/main/docs/CONSOLE_TRYBOOK.md)
- [Policy Reimbursement Demo](https://github.com/dr3d/prethinker/blob/main/docs/POLICY_REIMBURSEMENT_DEMO.md)
- [Demo Playbook](https://github.com/dr3d/prethinker/blob/main/docs/DEMO_PLAYBOOK.md)
- [Prethink Gateway MVP](https://github.com/dr3d/prethinker/blob/main/docs/PRETHINK_GATEWAY_MVP.md)

## History

Older parser-lane notes, generated run reports, dated handoffs, and retired
experiments are intentionally not kept in this front-door docs set. Git history
preserves the trail; this directory should describe the project as it works now.
