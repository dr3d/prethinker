...
- Needed now: `True`
- Reason: The controlled micro-fixture gate is now stable. The next external input is a clean-public-filings batch; a local offsite packet is prepared at tmp/legal_authority_clean_public_filings_work_order_20260606_r2.zip. Known hallucination/sanction filings remain deferred until the clean-public baseline lands.
