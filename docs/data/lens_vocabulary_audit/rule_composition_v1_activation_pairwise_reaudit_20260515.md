...
- Compiles: `1`
- Status counts: `{'not_applicable': 3, 'shallow_structural': 4, 'structural': 3}`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `lens_vocab_rule_composition_activation_anchor_compile_20260515` | `makerspace_tool_access` | 23 | 100 | 3 | 4 | 0 | 3 |

## Shallow Or Source-Only Terms

- `makerspace_tool_access` shallow: `exception`, `override`, `precedence`, `expiration`
