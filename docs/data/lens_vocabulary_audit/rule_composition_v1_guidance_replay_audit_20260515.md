...
- Compiles: `3`
- Status counts: `{'not_applicable': 4, 'shallow_structural': 10, 'source_only': 4, 'structural': 12}`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `lens_vocab_rule_composition_guidance_replay_compile_20260515` | `garden_plot_governance` | 25 | 120 | 5 | 2 | 2 | 1 |
...
- `garden_plot_governance` shallow: `base_rule`, `override`
