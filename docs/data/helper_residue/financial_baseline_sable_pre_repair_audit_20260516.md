...
- Compiles: `1`
- Status counts: `{'ledger_only': 2, 'partial': 6, 'pass': 3}`

## Fixture Summary

| Run | Fixture | Direct facts | Source-record facts | Pass | Partial | Candidate-only | Ledger-only | Fail | N/A |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `event_backbone_sable_recompile_20260516` | `sable_creek_budget` | 66 | 1592 | 3 | 6 | 0 | 2 | 0 | 0 |
...
- `financial_baseline_derivation_contract`: `partial`; missing keys `['scenario_or_basis']`
