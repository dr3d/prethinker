...
- Blackthorn hostile procedural-misconduct fixture admission: full suite `354 passed`; fixture contains source story, gold KB, 100 QA probes, ontology registry, support map, failure buckets, and progress journal. Baseline first-20 QA was `2 exact / 1 partial / 17 miss`. BTC-007 reached `49` admitted operations and first-20 QA `6 exact / 2 partial / 12 miss`. BTC-015 is the new high-water: compact `source_pass_ops_v1` focused passes plus registry-visible planning reached `105` admitted operations, expected-signature recall `0.551`, first-20 QA `11 exact / 3 partial / 6 miss`, loose support `9/20`, and loose query-signature matches `19/37`. The improvement preserves the authority boundary: the LLM proposes compact operation candidates, then the ordinary Semantic IR mapper admits or skips them.
