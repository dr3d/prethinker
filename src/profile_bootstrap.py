...
PROFILE_BOOTSTRAP_GUIDANCE = (
    ...
    "device_attribute/3, item_attribute/3, asset_attribute/3, or precise domain-owned equivalents. A profile that "
    "keeps only the device id plus status/certification rows is shallow when the source states distinct specification "
    "fields.\n"
    ...
    "semantic fact or only a source text row is shallow when later questions may ask which source coordinate states "
    "the basis.\n"
...
PROFILE_BOOTSTRAP_REVIEW_GUIDANCE = (
    ...
    "stated fields separately, recommend a reusable attribute capability such as equipment_attribute/3, "
    "device_attribute/3, item_attribute/3, asset_attribute/3, or precise domain-owned equivalents.\n"
