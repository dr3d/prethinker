...
class PrologMCPServer:
    ...
    def _compile_apply_parse(
        ...
        *,
        ...
        correction_input = self._clone_trace_payload(after_make_with)
                ...
                try:
                    ...
                    selection = {
                        ...
                        "action_plan": {
                            ...
                            "skip_heavy_steps": [],
                            "review_triggers": ["router_call_failed"],
                            "why": "fallback after semantic_router_v1 call failure",
                        },
                    ...
                    selection = parsed if isinstance(parsed, dict) else {
                        ...
                        "action_plan": {
                            "actions": ["compile_semantic_ir"],
                            "skip_heavy_steps": [],
                            "review_triggers": ["router_parse_failed"],
                            "why": "fallback after semantic_router_v1 parse failure",
                        },
    ...
    def _semantic_ir_context_audit(
        ...
        *,
        ...
        return {
            ...
            "action_plan": self._clone_trace_payload(selection.get("action_plan", {})),
