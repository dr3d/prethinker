    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "routing_policy": [
            ...
            "Do not choose sec_contracts@v0 merely because a rule uses if, unless, default, or deadline language when the record is a scholarship or benefit eligibility record, a probate trust/property transfer, or a legal/admin source-record correction; consider legal_courtlistener@v0 or probate@v0 primary and sec_contracts@v0 secondary.",
            ...
            "Disambiguation: choose legal_courtlistener@v0 for legal or administrative note/document date corrections, flood notes, eligibility records, scholarship or benefit rules, administrative findings, source logs, and record-backed temporal corrections when the turn is not estate/probate or contract-party obligation owned.",
            ...
            "Disambiguation: choose probate@v0 for estate-like trusts, educational trusts, property shares, nominal forced transfers, beneficiary or guardian asset transfers, and Silverton/Elias/Arthur/Alfred/A.S. follow-up identity or residency questions when recent_context carries that scenario pressure.",
