...
CARRIER_CONTRACT_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "sec_filing_item_treatment/4": {
        ...
        "contract": [
            ...
            "source_or_scope should identify the item heading or treatment sentence where the treatment is stated, not an exhibit-table row unless the treatment statement itself appears there.",
    ...
    "sec_exhibit/5": {
        ...
        "contract": [
            ...
            "Use exhibit_role=not_stated when the source table states a cover-page Inline XBRL exhibit but does not state whether that exhibit is filed, furnished, or incorporated by reference.",
