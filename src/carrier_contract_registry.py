...
CARRIER_CONTRACT_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "sec_filing_item/5": {
        ...
        "contract": [
            ...
            "item_role separates substantive items from exhibit, furnished, incorporated_reference, or other structural roles.",
        ...
        "value_domains": {
            ...
            "item_role": ["substantive", "exhibit", "furnished", "incorporated_reference", "other_role"],
        },
    ...
    "sec_exhibit/5": {
        ...
        "contract": [
            ...
            "exhibit_role states whether the exhibit is filed, furnished, incorporated_by_reference, embedded_ixbrl, or not_stated.",
        ...
        "value_domains": {
            ...
            "exhibit_role": ["filed", "furnished", "incorporated_by_reference", "embedded_ixbrl", "not_stated"],
        },
