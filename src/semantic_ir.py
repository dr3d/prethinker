...
SCHEMA_CONTRACT: dict[str, Any] = {
    ...
    "query_intents": [
        {
            "intent_type": "list|count|date|source_location|heading_scope|note_marker|signatory|comparison|duration|status|ordered_labeled_entry|amount_inventory|ratio_calculation|duration_quantity|biography_history|employment_history|role_transition|board_nominee_path|named_role_roster|document_chronology|unknown",
            "target_terms": [],
            "answer_constraints": [],
