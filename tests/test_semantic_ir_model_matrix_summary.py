...
class SemanticIRModelMatrixSummaryTests(unittest.TestCase):
        ...
        rows = [
            {
                ...
                "legacy": {"score": {"decision_ok": False, "rough_score": 0.25}},
                "semantic_ir": {
                    "score": {"decision_ok": True, "rough_score": 1.0},
            ...
            },
            {
                ...
                "semantic_model": "google/gemma-4-26b-a4b",
                "legacy": {"score": {"decision_ok": True, "rough_score": 0.75}},
                "semantic_ir": {
                    "score": {"decision_ok": False, "rough_score": 0.5},
    ...
    def test_format_markdown_renders_matrix_row(self) -> None:
        ...
        self.assertIn("| rule_mutation | `qwen/qwen3.5-9b` | 10 | 10/10 | 0.917 |", markdown)
