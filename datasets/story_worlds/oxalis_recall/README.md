...
It focuses on medical-device recall classification, distributor compliance, corrections, and regulatory status reasoning.
...
- recall-classification rule application;
- regulatory authority versus distributor claim separation;
- corrective-action and shipment-status tracking;
- safety-adjacent facts without clinical advice generation;
