...
COMPILE_SURFACE_INVARIANT_CONTEXT_V1 = [
    ...
    "Compile surface invariant rule: source/header/signature/correspondence lines that state a person plus role, office, institution, attendance duty, compiler/reviewer duty, or registrar/recorder duty should become direct role-bearing rows when compatible predicates exist. Do not leave the only role evidence inside source_record_text_atom/2.",
