...
SAFE_JOB_TEMPLATES = (
    ...
    },
    {
        ...
        "commands": [
            "git pull --ff-only origin main",
            "python -m pytest tests/test_rollup_domain_bootstrap_qa_scorecard.py tests/test_story_world_repair_targets.py tests/test_compare_domain_bootstrap_compiles.py tests/test_plan_story_world_fixture_runs.py tests/test_hermes_poll_mailbox.py",
        ],
        "timeout_seconds": 240,
    },
    {
    ...
    },
    {
        ...
        "commands": [
            "git pull --ff-only origin main",
            "python -m py_compile scripts/compare_domain_bootstrap_compiles.py scripts/rollup_domain_bootstrap_qa_scorecard.py scripts/plan_story_world_repair_targets.py scripts/plan_story_world_fixture_runs.py scripts/hermes_poll_mailbox.py scripts/autolab_queue_next_safe_jobs.py",
        ],
        "timeout_seconds": 180,
    },
)
