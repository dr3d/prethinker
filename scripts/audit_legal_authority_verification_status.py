...
def _ledger_query_summary(ledger_queries: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "unavailable_citation_lookups": len(ledger_queries.get("which_citation_lookups_are_unavailable") or []),
        ...
        "pin_unavailable": len(ledger_queries.get("which_pin_cites_are_unavailable") or []),
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Resolved / unresolved / ambiguous / invalid reporter / unavailable: `{summary['resolved']} / {summary['unresolved']} / {summary['ambiguous']} / {summary['invalid_reporter']} / {summary['unavailable']}`",
